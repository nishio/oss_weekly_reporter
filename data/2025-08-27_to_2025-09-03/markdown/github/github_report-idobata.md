...
期間: 2025-08-27T12:15:19.328671+09:00 から 2025-09-03T12:15:19.328671+09:00 まで
...
### [MyPage: 画像アップロードを削除し、6種類のアバター選択に変更](https://github.com/digitaldemocracy2030/idobata/pull/465)

**作成者:** blu3mo  
**作成日:** 2025-08-28T13:36:49Z  
**変更:** +95 -40 (10ファイル)  
**内容:**

このPRでは、マイページのプロフィール画像UIをアップロードからプリセットアバター選択へ置き換えました。
主な変更点:
MyPage: ファイルアップロードUIを削除し、6種類のアバターから選択可能に
- AuthContext:  を追加し、選択を localStorage に保存。初期化時は localStorage の値を優先
- 画像を追加
- Backend(userController): 新規ユーザーにランダムなデフォルトアバターを設定、プロフィール画像URLの解決を改善

注意:
- 画像選択は端末ごとの localStorage に保存され、サーバー側にはアップロードされません

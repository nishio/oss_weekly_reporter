...
期間: 2025-06-18T12:31:42.907910+09:00 から 2025-06-25T12:31:42.907910+09:00 まで
...
### [サイドバーが長いときにレイアウトが崩れる問題を解決](https://github.com/digitaldemocracy2030/idobata/pull/411)

**作成者:** jujunjun110  
**作成日:** 2025-06-21T03:41:54Z  
**変更:** +1 -1 (1ファイル)  
**マージ日:** 2025-06-21T03:42:02Z  
**内容:**
...
### [Add redirect from root path to README page](https://github.com/digitaldemocracy2030/idobata/pull/410)

**作成者:** jujunjun110+Devin  
**作成日:** 2025-06-21T02:05:13Z  
**変更:** +8 -2 (1ファイル)  
**マージ日:** 2025-06-21T02:09:33Z  
**内容:**

# Add redirect from root path to README page

## Summary
This PR implements a redirect from the root path "/" to "/view/README.md" in the policy-edit frontend application, improving user experience by automatically directing users to the README content when they access the application root.

## Changes Made
- **Modified `src/App.tsx`**:
  - Added `Navigate` import from `react-router-dom`
  - Replaced the index route element from `<ContentExplorer initialPath="" />` to `<Navigate to="/view/README.md" replace />`
  - Used `replace` prop to prevent adding the redirect to browser history

## Technical Details
- The redirect uses React Router's `Navigate` component with the `replace` prop for better UX
- Maintains the existing route structure - only the root path behavior is changed
- The existing ContentExplorer component handles README.md files correctly without modification
- All existing routes (like `/view/other-file.md`) continue to work as before

## Testing Results
✅ **Local Testing Completed**
- Started development server with `npm run dev`
- Verified that accessing `http://localhost:5173/` automatically redirects to `http://localhost:5173/view/README.md`
- Confirmed README content displays correctly after redirect
- Tested that existing routes still function properly

✅ **Quality Checks Passed**
- `npm run lint`: ✅ No errors (formatting applied automatically)
- `npm run typecheck`: ✅ No TypeScript errors  
- `npm run test`: ✅ All 13 tests passed

## Screenshots
![Redirect working correctly - shows README.md in URL and breadcrumb](https://devin-public-attachments.s3.dualstack.us-west-2.amazonaws.com/attachments_private/org_59RHUaMtRiE9rGRu/a930bdfe-59f4-4d53-884c-7dd9bedf49f7/localhost_5173_view_020357.png?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=ASIAT64VHFT7ZVIEP6QV%2F20250621%2Fus-west-2%2Fs3%2Faws4_request&X-Amz-Date=20250621T020512Z&X-Amz-Expires=604800&X-Amz-SignedHeaders=host&X-Amz-Security-Token=IQoJb3JpZ2luX2VjEOL%2F%2F%2F%2F%2F%2F%2F%2F%2F%2FwEaCXVzLWVhc3QtMSJFMEMCIAJUjmWHnfjyKnxQS41%2BmCyPN66f4hIQJjlUDk%2BG7nwxAh8jh5fEWti14HUZcR%2BXV5ry9m698HI392Gk%2BTNPAAABKsAFCMv%2F%2F%2F%2F%2F%2F%2F%2F%2F%2Fw